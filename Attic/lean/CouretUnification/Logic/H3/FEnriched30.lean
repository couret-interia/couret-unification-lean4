...
import CouretUnification.Logic.H3.FEnrichedSpec
...
open CouretUnification.H3.FEnriched
...
def fileIdentity : CouretUnification.FileIdentity where
  module := "CouretUnification.H3.FEnriched30"
  layer := CouretUnification.Layer.logicH3
  status := CouretUnification.EpistemicStatus.interface  -- [I] instance typée
  sorryCount := 0
  rhClaimed := false
