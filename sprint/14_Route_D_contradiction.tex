...
\paragraph{Objectif vis\'e.}
Comprendre si l'on peut \'etablir $\kappa(q_k)\ge\lambda>0$ le long
de la tour primoriale, par contradiction avec les r\'esultats~$\Omega$
de la th\'eorie analytique des nombres.
...
\]
Contradiction formelle avec $\kappa\to 0$,
\textbf{si le transfert aux copremiers \'etait disponible}
(cf.~verrou~1, \S D.4).
